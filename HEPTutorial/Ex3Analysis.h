...
#ifndef Ex3Analysis_h
#define Ex3Analysis_h
...
class Ex3Analysis: public TSelector {
public:
   ...
   Ex3Analysis(float sf = 1., float wf = 1, TTree * /*tree*/= 0) :
   fChain(0) {
      weight_factor = wf;
      SF_b = sf;
   }
...
#ifdef Ex3Analysis_cxx
void Ex3Analysis::Init(TTree *tree)
{
